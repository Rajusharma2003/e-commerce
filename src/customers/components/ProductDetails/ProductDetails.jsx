...
export default function ProductDetails() {
  ...
  return (
    <div className="bg-white lg:px-20">
      ...
      {/* This is the section for image and gallery */}
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4'>
          {/* Image gallery */}
          <div className="flex flex-col items-center">
            <div className="mt-10 overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
              <img
            ...
            { product.images.map((items ,index) => <div key={index} className="overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                <img
                  alt={items.alt}
                  src={items.src}
                  className="h-full w-full object-cover object-center"
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <form className="mt-10">
              ...
              <Button color='secondary' variant='contained' sx={{ px:"2rem" , py:"1rem" ,mt: "10px" }}>
                Add to bag
              </Button>
            </form>
          </div>
        ...
        {/* This is the section for rating and review */}
         <section>
            ...
            <Grid  container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <Grid container justifyContent='center' alignItems="center" gap={2}>
                  ...
                  <Grid item xs={7}>
                    <LinearProgress sx={{bgcolor:'#d0d0d0' , borderRadius:4 , height:7 , color:"yellow"}} variant='determinate' value={35} />
                  </Grid>
                </Grid>
